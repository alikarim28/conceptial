...
<style>
  ...
  <div class="container mt-5">
    ...
    or $product_brand==''or $product_price=='' or $product_image1=='' or $product_image2==''or $product_image3==''){
        ...
        $update_product = "update `product` set product_title ='$product_title',product_description = '$description',
        product_keywords = '$product_keywords',product_image1 = '$product_image1',product_image2 = '$product_image2',
        product_image3 = '$product_image3',product_price = '$product_price',date=NOW(),status = 'true',
        brand_id = '$product_brand',category_id = '$product_category',
        small_quantity ='$product_small',medium_quantity='$product_medium',large_quantity='$product_large',gender_id = '$product_gender'
